...
func (m *MockPresenter) CreateCompany(company *domain.Company) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CreateCompany", company)
}

// CreateCompany indicates an expected call of CreateCompany.
func (mr *MockPresenterMockRecorder) CreateCompany(company interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateCompany", reflect.TypeOf((*MockPresenter)(nil).CreateCompany), company)
}
...
func (m *MockPresenter) GetCompanies(companies domain.CompanyCollection) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "GetCompanies", companies)
}

// GetCompanies indicates an expected call of GetCompanies.
func (mr *MockPresenterMockRecorder) GetCompanies(companies interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCompanies", reflect.TypeOf((*MockPresenter)(nil).GetCompanies), companies)
}

// GetCompany mocks base method.
func (m *MockPresenter) GetCompany(company *domain.Company) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "GetCompany", company)
}

// GetCompany indicates an expected call of GetCompany.
func (mr *MockPresenterMockRecorder) GetCompany(company interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCompany", reflect.TypeOf((*MockPresenter)(nil).GetCompany), company)
}
...
// MockCompanyRW is a mock of CompanyRW interface.
type MockCompanyRW struct {
	ctrl     *gomock.Controller
	recorder *MockCompanyRWMockRecorder
}

// MockCompanyRWMockRecorder is the mock recorder for MockCompanyRW.
type MockCompanyRWMockRecorder struct {
	mock *MockCompanyRW
}

// NewMockCompanyRW creates a new mock instance.
func NewMockCompanyRW(ctrl *gomock.Controller) *MockCompanyRW {
	mock := &MockCompanyRW{ctrl: ctrl}
	mock.recorder = &MockCompanyRWMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCompanyRW) EXPECT() *MockCompanyRWMockRecorder {
	return m.recorder
}

// Create mocks base method.
func (m *MockCompanyRW) Create(company domain.Company) (*domain.Company, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCompanyRWMockRecorder) Create(company interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockCompanyRW)(nil).Create), company)
}

// CreateTx mocks base method.
func (m *MockCompanyRW) CreateTx(company domain.Company, tx *sql.Tx) (*domain.Company, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCompanyRWMockRecorder) CreateTx(company, tx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTx", reflect.TypeOf((*MockCompanyRW)(nil).CreateTx), company, tx)
}

// Delete mocks base method.
func (m *MockCompanyRW) Delete(id int) error {
	m.ctrl.T.Helper()
...
func (mr *MockCompanyRWMockRecorder) Delete(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockCompanyRW)(nil).Delete), id)
}

// GetAll mocks base method.
func (m *MockCompanyRW) GetAll() ([]*domain.Company, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCompanyRWMockRecorder) GetAll() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockCompanyRW)(nil).GetAll))
}

// GetById mocks base method.
func (m *MockCompanyRW) GetById(id int) (*domain.Company, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCompanyRWMockRecorder) GetById(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetById", reflect.TypeOf((*MockCompanyRW)(nil).GetById), id)
}

// Update mocks base method.
func (m *MockCompanyRW) Update(id int, company domain.Company) (*domain.Company, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCompanyRWMockRecorder) Update(id, company interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockCompanyRW)(nil).Update), id, company)
}
